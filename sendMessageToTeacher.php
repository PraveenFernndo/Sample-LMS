        ...
        <div class="row">
            ...
            <div class="col-lg-10 border rounded offset-lg-1 p-3 mt-5">
                <div class="row">
                    ...
                    if (!empty($_GET["i"])) {
                        $teacher_id = $_GET["i"];
                        $r = Database::search("select * from teacher where id='" . $teacher_id . "'");
                        $n = $r->num_rows;
                        $rs = $r->fetch_assoc();
                        $r1 = Database::search("select * from messages where `from`='wkapraveen@gamil.com' and `to`='".$rs["email"]."' order by date_time DESC");
                        $n1 = $r1->num_rows;
                        if ($n1 > 0) {
                            for ($x = 0; $x < $n1; $x++) {
                                $rs1 = $r1->fetch_assoc();
                ...
                <div class="col-12 mt-5">
                    <div class="row">
                        <div class="input-group">
                            ...
                            <button id="sendbtn" class="btn btn-link fs-2 bg-dark" onclick="newMessage('<?=$rs['email']?>');">
