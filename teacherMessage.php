...
$u=Database::search("select * from teacher where id='".$id."'");
$us=$u->fetch_assoc();
$email=$us["email"];
?>
...
<head>
    ...
    <title>Teacher Inboxed Messages</title>
            ...
            ?>
                ...
                <div class="col-lg-10 offset-lg-1 p-5 mt-5">
                    ...
                    for ($x = 0; $x < $n; $x++) {
                        ...
                        $r3 = Database::search("select * from user where email='" . $rs["from"] . "'");
                        $n3 = $r3->num_rows;
                        ...
                        <div class="col-12 border rounded p-3" style="cursor: pointer;">
                            <div class="row">
                                ...
                                <div class="col-lg-2">
                                    ...
                                    ?>
                                    <a  onclick="teacherViewMessages('<?= $rs['id'] ?>')" class="btn btn-primary mt-1">Reply</a>
                                </div>
                                <!-- last message -->
                            </div>
                        </div>
