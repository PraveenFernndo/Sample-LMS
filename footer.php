        ...
        <div class="col-12 text-md-start">
            <div class="row text-sm-center text-md-start">
                ...
                <div class="col-12 col-md-3 col-lg-3 mx-auto mt-3">
                    <h5 class="text-uppercase mb-4 text-warning">Tution.LK</h5>
                    <img src="pictures/logo.png" class="rounded"/>
                </div>

                <div class="col-12 col-md-3 col-lg-2 mx-auto mt-3">
                    <p>Copyright &copy;2022 Tution.lk All Right Reserved</p>
                </div>
                ...
                <p><i class="bi bi-house-door-fill"></i> Panadura, Paratta, Sri Lanka.</p>
                <p><i class="bi bi-envelope-fill"></i> tutionlanka@gmail.com</p>
