            ...
            ?>
                ...
                <div class="col-lg-10 offset-lg-1 p-5 mt-5">
                    ...
                    for ($x = 0; $x < $n; $x++) {
                        ...
                        $n3 = $r3->num_rows;
                        $r4 = Database::search("select * from user where email='" . $rs["from"] . "'");
                        $n4 = $r4->num_rows;
                        ...
                        if ($n3 > 0) {
                            ...
                            $rs4 = $r4->fetch_assoc();
                            $first_name = $rs4["first_name"];
                            $last_name = $rs4["last_name"];
                            $status = "Student";
                        }
                        ...
                        <div class="col-12 border rounded p-3" style="cursor: pointer;">
                            <div class="row">
                                ...
                                <div class="col-lg-2">
                                    ...
                                    ?>
                                    <a  onclick="adminViewMessages('<?= $rs['id'] ?>')" class="btn btn-primary mt-1">Reply</a>
                                </div>
                                <!-- last message -->
                            </div>
                        </div>
